...
import com.visionrent.service.ReportServica;
...
public class ReportController {
	...
	public ResponseEntity<Resource> getUserReport(){
		...
		ByteArrayInputStream bais = reportServica.getUserReport();
		
		InputStreamResource file = new InputStreamResource(bais);
		return ResponseEntity.ok().header(HttpHeaders.CONTENT_DISPOSITION, "attachment;fileName="+fileName).
				contentType(MediaType.parseMediaType("aplication/vmd.ms-excel")).body(file);
	}
	...
	public ResponseEntity<Resource> getCarReport(){
		...
		ByteArrayInputStream bais = reportServica.getCarReport();
	...
	public ResponseEntity<Resource> getReservationReport(){
		...
		ByteArrayInputStream bais = reportServica.getReservationReport();
