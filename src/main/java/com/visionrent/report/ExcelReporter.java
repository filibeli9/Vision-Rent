...
public class ExcelReporter {
	...
	static String[] USER_HEADERS= {"id","FirstName","LastName","PhoneNumber","Email","Address","PostCode","Roles"};
	...
	static String[] RESERVATION_HEADERS= {"id","CarId","CarModel","CustomerId","CustomerFullName","CustomerPhoneNumer","PickUpTime",
	...
	public static ByteArrayInputStream getUserExcelReport(List<User> users) throws IOException {
		...
		for (User user:users) {
			...
			row.createCell(6).setCellValue(user.getPostCode());
	...
	public static ByteArrayInputStream getReservationExcelReport(List<Reservation> reservations) throws IOException {
		...
		//Headers for reservation Report Excel
